...
export default function DataGridHero({
  ...
  return (
    <div className="data-grid-hero relative w-full overflow-hidden" style={{ background }}>
      <div ref={gridRef} className="grid-container" aria-hidden="true" />
      <div className="hero-content relative z-10 w-full" role="region" aria-label="Hero Content">
        {children}
      </div>
    </div>
  );
