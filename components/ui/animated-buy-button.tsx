    ...
    <div className="relative inline-flex items-center justify-center">
      <motion.button
        ...
        animate={{
          ...
          backgroundColor: status === 'success' ? '#10b981' : status === 'loading' ? '#18181b' : '#ffffff',
          color: status === 'success' ? '#ffffff' : status === 'loading' ? '#71dfbe' : '#000000',
        }}
        transition={{ duration: 0.4, ease: [0.16, 1, 0.3, 1] }}
        className={`relative overflow-hidden px-4 py-2.5 text-xs font-extrabold flex items-center justify-center gap-1.5 shadow-lg border border-white/20 cursor-pointer ${
